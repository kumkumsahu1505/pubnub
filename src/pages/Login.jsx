...
function Login() {
  ...
  >
    ...
    <p className='text-rose-700 flex justify-end'>Forgot your password?</p>

    {/* Submit */}
    <button
      type="submit"
      className="mt-4 bg-red-700 text-white py-2.5 rounded-md font-semibold hover:bg-red-700 transition"
    >
      Login
    </button>
  </form>
